    ...
    wx.chooseAddress({
      success: (res) => {
        ...
        Toast({
          context: this,
          selector: '#t-toast',
          message: i18n.t('Added successfully.'),
          icon: '',
          duration: 1000,
        });
        ...
        this.setData({
          [`addressList[${len}]`]: {
            ...
            isDefault: 0,
            tag: i18n.t('Shipping address from WeChat'),
            id: len,
          },
        });
      },
  ...
  confirmDeleteHandle({ detail }) {
    ...
    if (id !== undefined) {
      ...
      Toast({
        context: this,
        selector: '#t-toast',
        message: i18n.t('Address deleted successfully.'),
        theme: 'success',
        duration: 1000,
      });
    } else {
      Toast({
        context: this,
        selector: '#t-toast',
        message: i18n.t('To get address ID, a new version of component library is needed.'),
        icon: '',
        duration: 1000,
      });
    }
      ...
      .catch((e) => {
        if (e.message !== 'cancel') {
          Toast({
            context: this,
            selector: '#t-toast',
            message: i18n.t('Error occurred while editing address.'),
            icon: '',
            duration: 1000,
          });
        }
