...
const TitleConfig = {
  [ServiceType.ORDER_CANCEL]: i18n.t('Refund details'),
  [ServiceType.ONLY_REFUND]: i18n.t('Refund details'),
  [ServiceType.RETURN_GOODS]: i18n.t('Return and refund details'),
};
...
Page({
  ...
  editLogistices() {
    ...
    this.inputDialog._onConfirm = () => {
      Toast({
        message: i18n.t('Enter tracking number for your return'),
      });
    };
  },
