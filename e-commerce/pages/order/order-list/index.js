...
Page({
  ...
  data: {
    tabs: [
      ...
      { key: OrderStatus.PENDING_PAYMENT, text: i18n.t('To pay'), info: '' },
      { key: OrderStatus.PENDING_DELIVERY, text: i18n.t('To ship'), info: '' },
      { key: OrderStatus.PENDING_RECEIPT, text: i18n.t('To receive'), info: '' },
      { key: OrderStatus.COMPLETE, text: i18n.t('Completed'), info: '' },
    ],
    curTab: -1,
    orderList: [],
    listLoading: 0,
