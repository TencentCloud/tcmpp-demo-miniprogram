  ...
  methods: {
    ...
    onCancel() {
      Toast({
        context: this,
        selector: '#t-toast',
        message: i18n.t('You clicked to cancel the order'),
        icon: 'check-circle',
      });
    },
    ...
    onConfirm() {
      Dialog.confirm({
        title: i18n.t('Are you sure you want to confirm receipt? '),
        content: '',
        confirmBtn: 'Yes',
        cancelBtn: 'Cancel',
      })
        .then(() => {
          Toast({
            context: this,
            selector: '#t-toast',
            message: i18n.t('You confirm that you have received the order.'),
            icon: 'check-circle',
          });
        })
        .catch(() => {
          Toast({
            context: this,
            selector: '#t-toast',
            message: i18n.t('You canceled your receipt.'),
            icon: 'check-circle',
          });
        });
    },
    ...
    onPay() {
      Toast({
        context: this,
        selector: '#t-toast',
        message: i18n.t('You clicked Go to checkout'),
        icon: 'check-circle',
      });
    },
    ...
    onBuyAgain() {
      Toast({
        context: this,
        selector: '#t-toast',
        message: i18n.t('You clicked Buy again'),
        icon: 'check-circle',
      });
    },
    ...
    onViewRefund() {
      Toast({
        context: this,
        selector: '#t-toast',
        message: i18n.t('You clicked to view the refund'),
        icon: '',
      });
    },
